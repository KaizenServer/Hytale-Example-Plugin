...
/** /class choose — opens the class selection UI. No arguments required. */
public class ChooseClassCommand extends AbstractPlayerCommand {

    private final ClassService classService;
    private final ProfileService profileService;
    private final IUiPresenter uiPresenter;

    public ChooseClassCommand(ClassService classService, ProfileService profileService,
                               IUiPresenter uiPresenter) {
        super("choose", "Open the class selection menu.");
